...
required. Loosely based on shared_control/multi_counter_control.py's MultiCounterControl
...
from shared_control import MultiCounterControl
...
#
# 1. shared_control/multi_counter_control.py's MultiCounterControl (and this file's first attempt)
