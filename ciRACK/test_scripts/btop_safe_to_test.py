...
SafeToTestControl (shared_control/safe_to_test_control.py) -- NANDs them together (safe only
...
import sys
sys.dont_write_bytecode = True  # never cache .pyc for local modules -- always run current source
