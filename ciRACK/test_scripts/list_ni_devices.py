...
shared_control/multi_counter_control.py hardcodes (NI_DEVICES / NI_SOURCE: "Dev1" for the
...
print("--- Check against shared_control/multi_counter_control.py's hardcoded names ---")
...
print("shared_control/multi_counter_control.py's MultiCounterControl class to the real names.")
